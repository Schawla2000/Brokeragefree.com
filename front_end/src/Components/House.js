...
export default function House()  {
    const nevigate=useNavigate();
        ...
        const handleSubmit = (e) => {
            ...
            if(housedetails.name && housedetails.address && getcity && getcity && (9999999999>housedetails.mobileno && housedetails.mobileno>999999999) && housedetails.area && housedetails.price)
            {
                 axios({
                    method: "post",
                    url: "http://localhost:3011/inserthousedetails",
                    data: formData,
        ...
        const handlePhoto = (e) => {   
            ...
            {
              setgetImages(e.target.files[i]);
              //console.log(e.target.files[i]);
            }
            else{
                alert("Image size is greater than 1Mb");
            }
            console.log(getimages[i]);
            }
    ...
    return (
      <div>
          <Heading title="House Details"></Heading>
      ...
      <div id="main2">
            <form enctype="multipart/form-data" method='post' onSubmit={handleSubmit}>
                ...
                <tr className='r'><td><input type="file" accept=".png, .jpg, .jpeg,.jfif" name="photos" onChange={handlePhoto} multiple/></td></tr>
