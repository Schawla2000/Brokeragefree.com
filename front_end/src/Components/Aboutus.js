    ...
    <div className="container">
        <div className="row">
                	<div className="col-md-6">
                        ...
                        <p className="lead">This is the web portal for<br/>easy and quick for buy,Sell and rent of real estate property.</p>
                    </div>
</div>
    </div>
</div>
	...
	<div className="row" margin-left= "50">
		<div>
		    <div className="team-img thumbnail">
		        <img src={"./images/Ownerimages/DP.jpg"} style={{"height":"320px"}}/>
		    <div className="team-content">    
		        <h1>Sahil Chawla</h1>
		        <div className="border-team"></div>
		        <div className="social-icons"> 
               <a href="https://www.facebook.com/sahil.chawla.1999"><i id="social-fb" className="fa fa-facebook-square fa-3x social"></i></a>
